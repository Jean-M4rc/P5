...
@section('contenu')
    ...
    <form action="/nouvelleInscription" method="post" class="container mb-5">
        @csrf
        ...
        <fieldset id="seller_confirmation_check"><!-- Complément formulaire pour les vendeurs -->
            ...
            <div class="collapse container" id="sellercollapse">
                ...
                <div class="form-group row"><!-- Sélection des catégories -->
                    <label aria-describedby="categoriesHelp" class="col-12">Vos produits <span style="color:#772953">*</span><small id="categoriesHelp" class="form-text text-muted">Vous pouvez sélectionner plusieurs catégories.</small></label>
